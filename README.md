...
Predicts which files in a Git repository are most likely to need a bug fix next, using nothing but a file's commit history — how often it changes, how much, and by how many people. Built and demonstrated against `psf/requests`.
